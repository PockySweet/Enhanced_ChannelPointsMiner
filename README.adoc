image:https://raw.githubusercontent.com/PockySweet/repo-resources/main/buttons/DetaDeploy.svg[link="https://go.deta.dev/deploy?repo=https://github.com/PockySweet/Enhanced_ChannelPointsMiner",window="_blank",align="center"]
